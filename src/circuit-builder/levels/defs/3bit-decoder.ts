...
const level: Level = {
  ...
  predefinedGates: [
    ...
    { type: 'input', pos: { x: 2, y: 6 }, label: 'B', canRemove: false },
    { type: 'input', pos: { x: 2, y: 9 }, label: 'C', canRemove: false },
    { type: 'output', pos: { x: 27, y: 1 }, label: 'O0', canRemove: false },
    { type: 'output', pos: { x: 27, y: 4 }, label: 'O1', canRemove: false },
    { type: 'output', pos: { x: 27, y: 7 }, label: 'O2', canRemove: false },
    { type: 'output', pos: { x: 27, y: 10 }, label: 'O3', canRemove: false },
    { type: 'output', pos: { x: 27, y: 13 }, label: 'O4', canRemove: false },
    { type: 'output', pos: { x: 27, y: 16 }, label: 'O5', canRemove: false },
    { type: 'output', pos: { x: 27, y: 19 }, label: 'O6', canRemove: false },
