...
const level: Level = {
  ...
  outputs: [{ name: 'Out' }],
  predefinedGates: [
    { type: 'input',      pos: { x: -8, y: -3 }, label: 'en', canRemove: false },
    { type: 'input-8bit', pos: { x: -8, y: 0 }, label: 'A',  canRemove: false },
    { type: 'output-8bit', pos: { x: 5, y: 0 }, label: 'Out', canRemove: false },
  ],
