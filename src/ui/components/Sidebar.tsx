...
const CATEGORIES = [
  ...
  { label: '8-bit Logic', types: ['8bit-and', '8bit-or', '8bit-nor', '8bit-not', '8bit-shr', '8bit-shl'] },
  ...
  { label: 'Memory', types: ['delay', 'rs-latch', '1bit-memory', '8bit-memory', '8bit-counter', 'ram'] },
